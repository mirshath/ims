...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2024 at 12:44 PM
...
(20, 1, 'BTECH', 'Aut voluptatem labo', 'Hasni Nihar', 'English', '12 months', 95.00, 38.00, 53.00, 52.00, 'Bachelors,Diploma,CBM,Work Experience,IFD'),
(23, 14, 'GDM', 'Quos sapiente alias ', 'Imashi Abeysiriwardana', 'English', '6 months', 56.00, 37.00, 22.00, 51.00, 'Diploma,A/L,PGDip,IFD'),
(24, 1, 'FOOD SCIENCE', 'ds', 'Geethika Liyanage', 'English', '18 months', 9.00, 23.00, 91.00, 7.00, 'Bachelors,A/L,Work Experience,PGDip,IFD');
...
--
ALTER TABLE `program_table`
  MODIFY `program_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
