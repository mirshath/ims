        ...
        $('#student').change(function() {
            ...
            if (studentCode) {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            // Populate the fields with the values returned from the server
                            ...
                            if (data.compulsory_subs) {
                                // Process and display compulsory subjects (if necessary)
                            }
                            if (data.elective_subs) {
                                // Process and display elective subjects (if necessary)
                            }
                        } else {
