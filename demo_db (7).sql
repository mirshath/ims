...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2024 at 01:20 PM
...
INSERT INTO `allocate_programme` (`id`, `student_code`, `university_id`, `programme_code`, `batch_id`, `student_registration_id`, `elective_subs`, `compulsory_sub`) VALUES
(86, 8, 1, 20, 6, 'STU-000547879', 'IFD MODULE 1', ''),
(89, 8, 1, 20, 6, 'STU-000547879sadsad', 'IFD MODULE 1', '');
...
(11, 'EE_B3', 14, 26, '2022', '2024-10-17', '2024-11-01', '2024-10-03 08:29:15', '2024-10-03 08:29:15');
...
(96, 'Walk in', '2024-10-01 11:13:56');
...
(13, 'BIMT 410', 'IFD MODULE 3', 1, 20, '50% assignment', 50, 'Compulsory', '', '');
...
(20, 1, 'International Foundation Diploma (Business) – ATHE Level 3', 'Pp1', 'Hasni Nihar', 'English', '12 months', 250000.00, 300.00, 320.00, 250.00, 'Bachelor,Masters,Diploma,CBM,A/L,Work Experience,PGDip,IFD'),
...
(26, 14, 'DIE', 'ECODE2', 'Hasni Nihar', 'Tamil', '12 months', 2500.00, 2500.00, 2500.00, 2500.00, 'Diploma,CBM,A/L,Work Experience,PGDip,IFD');
...
ALTER TABLE `allocate_programme`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `student_registration_id` (`student_registration_id`) USING BTREE,
...
--
ALTER TABLE `program_table`
  MODIFY `program_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
