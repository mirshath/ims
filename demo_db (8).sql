...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2024 at 01:03 PM
...
(1, '1998-04-02', 'Social Media', 14, 'GDM', '2009-11-07', 'Nyssa', 'Solomon', 'Officia ut ab q', 'mykuk@mailinator.com', 'Amet mollitia volup', 'Contacted');
...
--
ALTER TABLE `leads`
  ADD CONSTRAINT `leads_ibfk_1` FOREIGN KEY (`university`) REFERENCES `universities` (`id`) ON UPDATE CASCADE;
